...
class Bounce_Screen extends StatefulWidget {
  Bounce_Screen({Key key}) : super(key: key);

  @override
  State<Bounce_Screen> createState() => _Bounce_ScreenState();
}

AppCubit appCubit = AppCubit();
List<Users> employeesList = [];

class _Bounce_ScreenState extends State<Bounce_Screen> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: CustomAppBar(
            title: "Bounce", haveNotf: false, haveBell: false, canPop: true),
